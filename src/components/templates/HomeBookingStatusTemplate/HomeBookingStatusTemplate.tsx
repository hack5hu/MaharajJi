...
} from './HomeBookingStatusTemplate.styles';
import { HomeBookingStatusTemplateProps } from './types.d';

export const HomeBookingStatusTemplate = React.memo(({
  headerTitle,
  avatarUrl,
  onMenuPress,
  activeTab,
  onTabChange,
  children,
}: HomeBookingStatusTemplateProps) => {
...
HomeBookingStatusTemplate.displayName = 'HomeBookingStatusTemplate';
