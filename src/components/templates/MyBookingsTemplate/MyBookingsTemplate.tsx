...
} from './MyBookingsTemplate.styles';
import { MyBookingsTemplateProps } from './types.d';

export const MyBookingsTemplate = React.memo(({
  headerTitle,
  avatarUrl,
  onMenuPress,
  activeTab,
...
MyBookingsTemplate.displayName = 'MyBookingsTemplate';
